...
class Lra(models.Model):
    ...
    add_suffix = models.CharField(max_length=-1, blank=True, null=True)
    ...
    acquisition_dt = models.CharField(max_length=-1, blank=True, null=True)
    ...
    value_est_dt = models.CharField(max_length=-1, blank=True, null=True)
    entered_date = models.CharField(max_length=-1, blank=True, null=True)
    usage = models.CharField(max_length=-1, blank=True, null=True)
    cost = models.FloatField(blank=True, null=True)
    property_source = models.CharField(max_length=-1, blank=True, null=True)
    purchase_type = models.CharField(max_length=-1, blank=True, null=True)
    parcel_status = models.CharField(max_length=-1, blank=True, null=True)
    fulladdress = models.CharField(max_length=-1, blank=True, null=True)
